...
![Client-Server Model](../Fab_academy/imgs/Client-server-model.svg)
...
![MQTT](../Fab_academy/imgs/MQTT_publish.png)
...
![ESP-NOW](../Fab_academy/imgs/ESPNOW.webp)
